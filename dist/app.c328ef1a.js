...
var carouselItemImg = document.querySelector(".carousel-item-img");
var carouselItemName = document.querySelector(".carousel-item-name");
var carouselItemLink = document.querySelector(".carousel-item-link");
